...
QChart* tresorie::chart_pie()
 {
     QSqlQuery q1,q2,q3,q4;
     qreal tot=0,c1=0,c2=0,c3=0;

     q1.prepare("SELECT * FROM TRESORIE");
     q1.exec();

     q2.prepare("SELECT * FROM TRESORIE WHERE TYPE = 'don' ");
     q2.exec();

     q3.prepare("SELECT * FROM TRESORIE WHERE TYPE = 'facture'");
     q3.exec();

     q4.prepare("SELECT * FROM TRESORIE WHERE TYPE != 'don' AND TYPE != 'facture'");
     q4.exec();
 ...
 //     Define slices and percentage of whole they take up
     ...
     series->append("don ", c1);
     series->append("facture", c2);
